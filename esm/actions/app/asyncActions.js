...
export const toggleSignin = bol => async dispatch => dispatch(actions.toggleSignin(bol));
...
export const executeSearch = (query, history, categoryId) => async function thunk(dispatch) {
